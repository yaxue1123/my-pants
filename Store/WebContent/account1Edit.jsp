...
<table class="main">
	...
	<form class="pure-form pure-form-aligned" method="post"
		action="Account1?action=save">
		<fieldset>
			<legend>账户编辑</legend>
			<div class="pure-control-group">
				<label for="txtProductName">用户名</label> <input id="txtProductName"
					name="userName" type="text" placeholder="产品名称"
					value="${account.userName}" />
			</div>
			<div class="pure-control-group">
				<label for="txtCategory">账户余额</label> <input id="txtCategory"
					name="money" type="text" placeholder="产品类型"
					value="${account.money}" />
			</div>
