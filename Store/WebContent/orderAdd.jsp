...
<table class="main">
		...
		<tr>
			...
			<td>
			<br><br>
		<form class="pure-form pure-form-aligned" method="post" action="Order?action=aadd">
    <fieldset>
    <legend>订单添加</legend>
        <div class="pure-control-group">
            <label>订单金额</label>
            <input id="txtProductName" name="price" type="text"/>
        </div>
        <div class="pure-control-group">
            <label>购买用户</label>
            <input id="txtCategory" name="userName" type="text"/>
        </div>
        <div class="pure-control-group">
            <label >收件人姓名</label>
            <input id="txtPrice" name="consignee" type="text"/>
        </div>
        <div class="pure-control-group">
            <label >联系电话</label>
            <input id="txtPrice" name="tele" type="text"/>
        </div>
		<div class="pure-control-group">
            <label>收件地址</label>
            <textarea id="txtMemo" name="address"></textarea>
        </div>
