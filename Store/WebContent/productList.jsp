...
<table class="main">
		...
		<div class="pure-controls">
			<a class="pure-button" href="productAdd.jsp">添加产品</a>
		</div>
		
		<br />
			<table class="pure-table pure-table-horizontal">
				<thead>
					<tr><th>编号</th><th>产品名称</th><th>分类</th><th>价格</th><th>描述</th><th>性别</th><th>大小</th><th>颜色</th><th>库存</th><th colspan="2">操作</th></tr>
				</thead>
				<tbody bgcolor="white">
