...
<body>
	...
	<fieldset>
	  <legend style="font-size:16px;">结果</legend>
	 	<h3 style="margin:20px;">成功加入购物车!</h3>
	 	<!-- <a href="window.history.back(-1)" style="font-size:16px;margin:20px;">返回继续购物</a> -->
	 	<a href="mainPage.jsp" style="font-size:16px;margin:20px;">返回继续购物</a>
	 </fieldset>
		</div>
</body>
</html>
