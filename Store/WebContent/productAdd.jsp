...
<table class="main">
		...
		<tr>
			...
			<td>
			<br><br>
		<form class="pure-form pure-form-aligned" method="post" action="Product?action=add">
    <fieldset>
    <legend>产品添加</legend>
        <div class="pure-control-group">
            <label for="txtProductName">产品名称</label>
            <input id="txtProductName" name="productName" type="text" placeholder="产品名称" />
        </div>
        <div class="pure-control-group">
            <label for="txtCategory">产品类型</label>
            <input id="txtCategory" name="category" type="text" placeholder="产品类型" />
        </div>
        <div class="pure-control-group">
            <label for="txtPrice">产品价格</label>
            <input id="txtPrice" name="price" type="text" placeholder="产品价格" />
        </div>
		<div class="pure-control-group">
            <label for="txtMemo">产品描述</label>
            <textarea id="txtMemo" name="memo" placeholder="产品描述"></textarea>
        </div>
        <div class="pure-control-group">
            <label for="txtMemo">产品性别</label>
            <input id="txtMemo" name="sex" placeholder="产品性别"></input>
        </div>
        <div class="pure-control-group">
            <label for="txtMemo">产品大小</label>
            <input id="txtMemo" name="size" placeholder="产品大小"></input>
        </div>
        <div class="pure-control-group">
            <label for="txtMemo">产品颜色</label>
            <input id="txtMemo" name="color" placeholder="产品颜色"></input>
        </div>
        <div class="pure-control-group">
            <label for="txtMemo">库存数量</label>
            <input id="txtMemo" name="stock" placeholder="库存数量"></input>
        </div>
